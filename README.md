...
-   Provided a `docker-compose.yml` file that builds and runs all
    services.
...
-   Selected AI/LLM model runs **locally** using **Ollama**.
-   The selected LLM should is (can be changed according to your machine's resources. Better LLM == faster and more accurate responses):
